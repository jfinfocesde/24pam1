...
* **Polimorfismo:** La capacidad de una subclase de redefinir los métodos de la clase padre, permitiendo que un mismo método tenga diferentes comportamientos en diferentes clases.
...
* **Polimorfismo:** Permite usar objetos de diferentes clases con el mismo método, sin tener que conocer su tipo específico.
